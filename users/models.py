...
class Payment(models.Model):
    ...
    product_id = models.CharField(max_length=255, blank=True, null=True, verbose_name="Product ID")

    price_id = models.CharField(max_length=255, blank=True, null=True, verbose_name="Price ID")

    checkout_session_id = models.CharField(max_length=350, blank=True, null=True, verbose_name="Checkout Session ID")

    payment_url = models.URLField(max_length=600, blank=True, null=True, verbose_name="Ссылка для оплаты")
