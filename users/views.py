...
from .services import convert_usd_to_rub, create_checkout_session, create_stripe_price, create_stripe_product
...
class PaymentViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=False, methods=["post"], permission_classes=[IsAuthenticated], url_path="create-payment")
    def create_payment(self, request):
        """Функция создания оплаты"""
        ...
        session = create_checkout_session(price_id=price.id, success_url=success_url, cancel_url=cancel_url)
